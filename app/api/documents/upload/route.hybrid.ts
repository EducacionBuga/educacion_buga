// filepath: d:\Clients\Secretaria de buga\sistema-educativo\app\api\documents\upload\route.ts
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!file || !areaSlug || !moduleType || !name || !folderId) {
    ...
    console.log(`Subiendo documento: ${name} para área: ${areaSlug}, módulo: ${moduleType}`)

    // Usar servicio híbrido para subir el documento (R2 + Supabase)
